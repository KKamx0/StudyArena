...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-6 py-12 text-white">
      <section className="w-full max-w-md rounded-2xl border border-purple-400/30 bg-slate-900/95 p-8 shadow-2xl shadow-purple-950/40">
        <p className="text-sm font-bold uppercase tracking-[0.25em] text-cyan-300">
          StudyArena
        </p>
        <h1 className="mt-3 text-4xl font-black tracking-tight">Log In</h1>
        <p className="mt-3 text-sm leading-6 text-slate-300">
          Welcome back. Log in to keep your profile, coins, level, and XP.
        </p>
        ...
        <p className="mt-6 text-center text-sm text-slate-300">
          Need an account?{" "}
          <Link href="/signup" className="font-bold text-cyan-300">
            Sign up
          </Link>
        </p>
      </section>
